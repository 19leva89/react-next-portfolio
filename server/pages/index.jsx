						...
						<div className="blogs-category flex flex-center">
							<table>
								...
								<tbody>
									<tr>
										<td>Node JS</td>
										<td>{blogsData.filter((item) => item.blogCategory[0] === 'nodejs').length}</td>
									</tr>

									<tr>
										<td>React JS</td>
										<td>{blogsData.filter((item) => item.blogCategory[0] === 'reactjs').length}</td>
									</tr>

									<tr>
										<td>Next JS</td>
										<td>{blogsData.filter((item) => item.blogCategory[0] === 'nextjs').length}</td>
									</tr>
